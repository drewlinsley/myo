...
echo "=== Experiment 1: 2D U-Net + ImageNet (Pearson only) ==="
...
echo "=== Experiment 2: 3D U-Net + ImageNet (Pearson only) ==="
python train.py -c configs/unet_3d_imagenet_pearson.yaml
python predict.py -c configs/unet_3d_imagenet_pearson.yaml --checkpoint ckpts/unet_3d_imagenet_pearson/best.pth --output_dir predictions/unet_3d_imagenet_pearson
python evaluate.py --pred_dir predictions/unet_3d_imagenet_pearson --data_dir data --output_dir results/unet_3d_imagenet_pearson --z_range $Z_RANGE

echo "=== Experiment 3: 2D U-Net + ImageNet ==="
...
echo "=== Experiment 4: 3D U-Net + ImageNet ==="
...
echo "=== Experiment 5: 2D U-Net + Random ==="
...
echo "=== Experiment 6: 3D U-Net + Random ==="
...
echo "=== Experiment 7: pix2pix-turbo ==="
...
echo "=== Comparison ==="
python evaluate.py --compare results/unet_2d_imagenet_pearson results/unet_3d_imagenet_pearson results/unet_2d_imagenet results/unet_3d_imagenet results/unet_2d_random results/unet_3d_random results/pix2pix_turbo
