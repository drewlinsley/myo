...
class SegmentationModel(torch.nn.Module):
    ...
    def forward(self, x, return_features=False):
        ...
        if return_features:
            decoder_output, latents = self.decoder(*features, return_features=return_features)
        else:
            decoder_output = self.decoder(*features, return_features=return_features)
        ...
        if return_features:
            return masks, decoder_output, latents
